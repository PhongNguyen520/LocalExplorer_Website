  ...
  <section id="destinations" className="py-20 bg-gray-50">
    <div className="max-w-7xl mx-auto px-6">
      ...
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl font-bold text-gray-900 mb-4">Explore Vietnam's Best</h2>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Discover the most popular destinations and experiences curated by our local experts and fellow travelers.
        </p>
      </div>
