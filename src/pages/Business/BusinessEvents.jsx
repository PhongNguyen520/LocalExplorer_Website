            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-2 gap-4 text-sm mb-4">
                <div>
                  ...
                  <p className="font-medium">{format(new Date(event.startDate), "d 'tháng' M, HH:mm", { locale: vi })}</p>
                </div>
                <div>
                  <p className="text-gray-600">Ngày kết thúc:</p>
                  <p className="font-medium">{format(new Date(event.endDate), "d 'tháng' M, HH:mm", { locale: vi })}</p>
                </div>
                {/* <div>
